...
public class SmallPacket implements DataPacket{
	...
	public SmallPacket(byte[] raw) throws DatagramDataSizeException{
	...
	public SmallPacket(byte source, byte destination, byte hops, byte sequencenr, byte[] data, Boolean ack, Boolean routing, Boolean keepalive, Boolean more) throws DatagramDataSizeException{
